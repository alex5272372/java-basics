...
public class FamilyController {
    ...
    private int doAction(int state, Deque<String> params) {
        switch (state) {
            ...
            case 501:
                Logger.info("countFamiliesWithMemberNumber: " + countFamiliesWithMemberNumber(Integer.parseInt(params.poll())));
                return 0;
    ...
    private int processState(int state, Deque<String> params) throws FamilyOverflowException {
        ...
        || state == 811 || state == 812 || state == 821 || state == 822 || state == 823) {
            ...
            try {
                ...
                Logger.error("Your input is invalid, please try again");
                return state;
            }
