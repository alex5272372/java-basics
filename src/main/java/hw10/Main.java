...
public class Main {
    public static void main(String[] args) {
        ...
        Woman mother1 = new Woman("Kate1", "Karleone1", new GregorianCalendar(1965, 10, 20), 65);
        Man father1 = new Man("John1", "Karleone1", new GregorianCalendar(1967, 5, 8), 67);
        ...
        Woman mother2 = new Woman("Kate2", "Karleone2", new GregorianCalendar(1965, 10, 20), 65);
        Man father2 = new Man("John2", "Karleone2", new GregorianCalendar(1967, 5, 8), 67);
        ...
        Woman mother3 = new Woman("Kate3", "Karleone3", new GregorianCalendar(1965, 10, 20), 65);
        Man father3 = new Man("John3", "Karleone3", new GregorianCalendar(1967, 5, 8), 67);
        ...
        family3.getChild(2).setBirthDate(new GregorianCalendar(2000, 3, 23));
