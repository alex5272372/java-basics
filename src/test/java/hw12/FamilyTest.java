...
public class FamilyTest {
    ...
    public void testAddChildObj() {
        ...
        String expectedResult = "Family:\n" +
                ...
                "    children:\n" +
                "        {name='Anna', surname='Karleone', birthDate=20/11/1990, iq=72, schedule={}}\n" +
                "    pets:\n" +
                "        DOMESTIC_CAT{nickname='tom', age=3, trickLevel=60, habits=[], numberOfLegs=4, isHasFur=true, isCanFly=false}";
    ...
    public void testDeleteChildIntOut() {
        ...
        String expectedResult = "Family:\n" +
                ...
                "    father: {name='John', surname='Karleone', birthDate=08/05/1967, iq=67, schedule={}}\n" +
                "    children:\n" +
                "        {name='Mark', surname='Karleone', birthDate=10/03/1988, iq=70, schedule={}}\n" +
                "    pets:\n" +
                "        DOMESTIC_CAT{nickname='tom', age=3, trickLevel=60, habits=[], numberOfLegs=4, isHasFur=true, isCanFly=false}";
        String actualResult = family.toString();
        Assert.assertEquals(expectedResult, actualResult);
