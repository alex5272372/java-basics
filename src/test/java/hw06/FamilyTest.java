...
public class FamilyTest {
    ...
    public void testAddChildObj() {
        ...
        String expectedResult = "Family{\n" +
                "    mother=Human{name='Kate', surname='Karleone', year=1965, iq=65, schedule=[]},\n" +
                "    father=Human{name='John', surname='Karleone', year=1967, iq=67, schedule=[]},\n" +
                "    children=[Human{name='Mark', surname='Karleone', year=1988, iq=70, schedule=[]}, Human{name='Anna', surname='Karleone', year=1990, iq=72, schedule=[[SUNDAY: Task 1][MONDAY: Task 2][TUESDAY: Task 3]]}, Human{name='First', surname='Karleone', year=1992, iq=55, schedule=[]}],\n" +
                "    pet=CAT{nickname='tom', age=3, trickLevel=60, habits=[eat, drink, sleep], numberOfLegs=4, isHasFur=true, isCanFly=false}}";
    ...
    public void testDeleteChildInt() {
        ...
        String expectedResult = "Family{\n" +
                "    mother=Human{name='Kate', surname='Karleone', year=1965, iq=65, schedule=[]},\n" +
                "    father=Human{name='John', surname='Karleone', year=1967, iq=67, schedule=[]},\n" +
                "    children=[Human{name='Anna', surname='Karleone', year=1990, iq=72, schedule=[[SUNDAY: Task 1][MONDAY: Task 2][TUESDAY: Task 3]]}],\n" +
                "    pet=CAT{nickname='tom', age=3, trickLevel=60, habits=[eat, drink, sleep], numberOfLegs=4, isHasFur=true, isCanFly=false}}";
        String actualResult = family.toString();
        Assert.assertEquals(expectedResult, actualResult);
    }
    ...
    public void testDeleteChildIntOut() {
        ...
        String expectedResult = "Family{\n" +
                "    mother=Human{name='Kate', surname='Karleone', year=1965, iq=65, schedule=[]},\n" +
                "    father=Human{name='John', surname='Karleone', year=1967, iq=67, schedule=[]},\n" +
                "    children=[Human{name='Mark', surname='Karleone', year=1988, iq=70, schedule=[]}, Human{name='Anna', surname='Karleone', year=1990, iq=72, schedule=[[SUNDAY: Task 1][MONDAY: Task 2][TUESDAY: Task 3]]}],\n" +
                "    pet=CAT{nickname='tom', age=3, trickLevel=60, habits=[eat, drink, sleep], numberOfLegs=4, isHasFur=true, isCanFly=false}}";
        String actualResult = family.toString();
        Assert.assertEquals(expectedResult, actualResult);
    }
